...
public class Boat
{
    ...
    //method
    public virtual void Boat_method()
    {
        Console.WriteLine("The Boat sails the seas");
    }
    public void Boat_method(string Boat_hullcolor)
    {
        Console.WriteLine($"The {Boat_hullcolor} Boat sails the seas");
    }
}
...
public class Boat_child : Boat
{
    ...
    public override void Boat_method()
    {
...
class Program
{
    ...
    {
        Boat_child battleship = new Boat_child();
        battleship.Boat_method();
    }
}